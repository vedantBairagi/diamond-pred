...
def user_input():
    carat = st.sidebar.slider('Carat Value', df['carat'].min(), df['carat'].max(), df['carat'].mean())
    ...
    depth = st.sidebar.slider('Depth Value', df['depth'].min(), df.depth.max(), df.depth.mean())
    table = st.sidebar.slider('Table Value', df.table.min(), df.table.max(), df.table.mean())
    x = st.sidebar.slider('X (Length mm)', df['x'].min(), df['x'].max(), df['x'].mean())
    y = st.sidebar.slider('Y (Width mm)', df['y'].min(), df['y'].max(), df['y'].mean())
    z = st.sidebar.slider('Z (Depth mm)', df['z'].min(), df['z'].max(), df['z'].mean())
